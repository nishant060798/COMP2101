...
#unpack the tar file and remove if it successful
test -f ~/Pictures/pics.tgz && tar && wget -x -0 ~/pictures/pics.tgz && rm ~/Pictures/pics.tgz

##################
#summarize and report what we have in pictures directory
